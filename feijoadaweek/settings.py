"""
Django settings for feijoadaweek project.
...
ROOT_URLCONF = 'feijoadaweek.urls'
...
WSGI_APPLICATION = 'feijoadaweek.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'feijoadaweek'),
        'USER': os.environ.get('DB_USER', 'feijoadaweek'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'feijoadaweek'),
